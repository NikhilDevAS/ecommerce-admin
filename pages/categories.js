...
function Categories({ swal }) {
  ...
  function handlePropteryNewName(index, property, newName) {
    setProperties((prev) => {
  ...
  function handlePropteryNewValues(index, property, newValues) {
    setProperties((prev) => {
      const properties = [...prev];
      ...
      <form onSubmit={saveCategory} className="">
        ...
        <div className="mb-4">
          ...
          <button
            type="button"
            onClick={() => addProperty()}
            className="btn-default text-sm mb-3"
          >
            Add New Property
          </button>
          {properties?.length > 0 &&
              ...
              return (
                <div className="flex gap-2 mb-4" key={index}>
                  <input
                    ...
                    value={property.name}
                    onChange={(e) =>
                      handlePropteryNewName(index, property, e.target.value)
                    }
                    placeholder="Property (Example : Color)"
                  />
                  <input
                    className="mb-0"
                    type="text"
                    ...
                    onChange={(e) =>
                      handlePropteryNewValues(index, property, e.target.value)
                    }
